...
// Find the difference between two numbers like 5 and 10 
...
console.log(Math.trunc(3.0000001)); // 3 
console.log(Math.floor(3.0000001)); // 3 
...
// Math.random() - can be used to generate random numbers between any 2 numbers
console.log(Math.random()); // 0 to 0.99999...
console.log(Math.random() * 10); 
console.log(Math.floor(Math.random() * 10)); 
 
// Generate a random number between 7 and 9  
// Math.floor(Math.random() * (max - min + 1)) + min
console.log(Math.floor(Math.random() * (9 - 7 + 1) + 7));
 
// Generate random number between 17 and 25 
